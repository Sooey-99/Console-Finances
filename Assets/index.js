...
var netTotal = 0;
// Iterate through the finances array and sum up the Profit/Losses
...
//The average of the **changes** in Profit/Losses over the entire period. Tracking what the total change in Profit/Losses are from month to month and then finding the average.
// Using calc = (`Total/(Number of months - 1)`)

// Step 1 initialize variables to store total change and the number of changes
var totalChange = 0;
var numChanges = 0;
...
// Check if the current change is greater than the previous greatest increase
if (change > greatestIncrease) {
greatestIncrease = change;
greatestIncreaseDate = finances[i][0]; // Store the corresponding date
}
}

// Log the greatest increase and its date to the console
